 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "USING DELTA\n",
    "LOCATION 'abfss://bronze@stspmobilitydev001dev001.dfs.core.windows.net/gtfs_routes'\n",
    "\"\"\")\n",
    "\n",
    "spark.sql(\"\"\"\n",
    "CREATE TABLE IF NOT EXISTS sp_mobility_bronze.gtfs_trips\n",
    "USING DELTA\n",
    "LOCATION 'abfss://bronze@stspmobilitydev001dev001.dfs.core.windows.net/gtfs_trips'\n",
    "\"\"\")\n",
    "\n",
    "spark.sql(\"\"\"\n",
    "CREATE TABLE IF NOT EXISTS sp_mobility_bronze.gtfs_stops\n",
    "USING DELTA\n",
    "LOCATION 'abfss://bronze@stspmobilitydev001dev001.dfs.core.windows.net/gtfs_stops'\n",
    "\"\"\")\n",
    "\n",
    "spark.sql(\"\"\"\n",
    "CREATE TABLE IF NOT EXISTS sp_mobility_bronze.gtfs_stop_times\n",
    "USING DELTA\n",
    "LOCATION 'abfss://bronze@stspmobilitydev001dev001.dfs.core.windows.net/gtfs_stop_times'\n",
    "\"\"\")\n",
    "\n",
    "spark.sql(\"\"\"\n",
    "CREATE TABLE IF NOT EXISTS sp_mobility_bronze.gtfs_calendar\n",
    "USING DELTA\n",
    "LOCATION 'abfss://bronze@stspmobilitydev001dev001.dfs.core.windows.net/gtfs_calendar'\n",
    "\"\"\")\n",
    "\n",
    "spark.sql(\"\"\"\n",
    "CREATE TABLE IF NOT EXISTS sp_mobility_bronze.gtfs_shapes\n",
    "USING DELTA\n",
    "LOCATION 'abfss://bronze@stspmobilitydev001dev001.dfs.core.windows.net/gtfs_shapes'\n",
    "\"\"\")\n",
    "\n",
