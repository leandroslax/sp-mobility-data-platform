 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "gold_mobility_kpis_path = \"abfss://gold@stspmobilitydev001dev001.dfs.core.windows.net/mobility_kpis\"\n",
    "\n",
    "# COMMAND ----------\n",
    "\n",
    ...
    "\n",
    "display(\n",
    "    dbutils.fs.ls(\"abfss://gold@stspmobilitydev001dev001.dfs.core.windows.net/mobility_kpis\")\n",
    ")\n",
    "\n",
    "# COMMAND ----------\n",
    "\n",
